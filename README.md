...
<p align="right">تمامی فایلهایی که پسوند مورد نظر را  داشته باشند به مرحله ی استیجینگ می برد</p>
<br>
<hr>
...
### `git tag -f <tag name> <commit id>` example `git tag -f v2.1.1 6d2ef95` :
