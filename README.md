...
### `git brancnh -m <new-name>` or `git brancnh -m <branch-name> <new-name>` :
...
<table align="center">
    ...
    <tbody>
        ...
        <tr>
            <td align="center"><h3><code>git diff <span><first-hash-commit></span> <span><second-hash-commit></span> or git diff 28344dc 85d9a5b or git diff 28344dc..85d9a5b</code></h3></td>
