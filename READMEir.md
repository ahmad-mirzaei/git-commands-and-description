...
| `git reset --hard [hash-commit]` | تمام پروژه را می برد به همان کامیتی که میخواهیم و حتی مرحله ی ورکینگ دایرکتوری را هم تغییر میدهد.. یعنی تغییرات هم بر میگردند به همان کامیتی که خواسته ایم..
