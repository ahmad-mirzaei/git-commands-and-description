...
| `git push -u origin main` | با اجرای این دستور، ریموت و برنچ برای ما ست می شوند تا دیگر برای آپلود تغییرات روی گیت هاب نیازی به نوشتن آنها نباشد و برای بارهای بعدی فقط می توان از دستور زیر استفاده کرد<br /> `git push` |
| `` |  |
<br />
