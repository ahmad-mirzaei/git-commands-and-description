...
| `git reset [hash-commit]` or `git reset --mixed [hash-commit]` | همانند دستور قبلی عمل می کند یعنی بر میگردد به کامیت قبلی و کامیت های بالایی را از ریپوزیتوری حذف می کند اما با این تفاوت که تغییرات را اگر در مرحله ی استیجینگ باشند، به مرحله ی ورکینگ دایرکتوری می برد و اگر در مرحله ی ورکینگ دایرکتوری باشند، آنها را **آنترک** میکند |
| `` |  |
<br />
