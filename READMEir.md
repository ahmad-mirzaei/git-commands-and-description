...
| `git restore --source [hash-commit] [file-name] ` | این دستور شبیه دستور زیر است: <br />  git checkout [hash-commit] [file-name] <br /> اما با این تفاوت که، ولی با این تفاوت که هد جابجا یا **دیتچ** نمی شود. یعنی داریم میگوییم که فایل مورد نظر را برگردان به فلان کد هش یا سورس  مورد نظر|
| `` |  |
| `` |  |
| `` |  |
<br />
