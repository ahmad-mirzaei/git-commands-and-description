...
| توضیحات | دستورات | 
|-----|-----:|
| `git revert [hash-commit]` | از این دستور زمانی استفاده می شود که، به فرض مثال یک زمانی یک کامیتی ایجاد کرده ایم و حال متوجه می شویم که آن کامیت به درد پروژه نمی خورد؛ مثلاً میخواهیم هر کدی که قبلاً در فایل مورد نظر بوده پاک شود و کدهایی که قبلاً پاک کرده بودیم برگردند |
<br />
